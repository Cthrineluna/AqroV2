  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Animated.View>
          <Text style={styles.title}>Scan with Aqro</Text>
          <Text style={styles.description}>
            Scan, save, and make a difference with our simple QR code solution. 
            Join our community in making sustainable choices easier.
          </Text>
        </Animated.View>
      </View>
    </View>
